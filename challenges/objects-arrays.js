...
const unisWithUni = graduates.filter(function(haveString){
    return haveString.university.includes("Uni")
});
...
*/
const displayNames = [];
zooAnimals.forEach(function(ele){
...
*/
const populationTotal = zooAnimals.reduce(function(accum, animal){
    return accum + animal.population;}, 0);
